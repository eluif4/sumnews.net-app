...
import { signInWithGoogle, logoutUserFromGoogle } from '../scripts/signIn';
...
<template>
    <div id="container">
        ...
        <div class="signincontainer">
            ...
            <SignInUsing :platform="googlePlatform" v-if="!userProfile.user" style="max-width: 100%; width: 100%;">
            </SignInUsing>
            <div class="userInfo" v-else>
                ...
                <div class="logout"><button @click="logoutUserFromGoogle">Log Out</button></div>
            </div>
        </div>
