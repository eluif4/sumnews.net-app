...
async function skipSignIn() {
    // Set 'skippedLogin' cookie, with value: true, to expire in 7 days;
    setCookie('visitedLoginPage', true, 7);
    router.push({ name: 'home' });
}
</script>
...
<template>
    <div id="page">
        ...
        <div class="flexContainer">
            ...
            <div class="info">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" id="svg_notice">
                    <path
                    ...
                    <path d="M12 8.13V12.96" stroke="#292D32" stroke-width="1.5" stroke-linecap="round"
                        stroke-linejoin="round" />
                    <path d="M11.9945 16H12.0035" stroke="#292D32" stroke-width="2" stroke-linecap="round"
                        stroke-linejoin="round" />
                </svg>
                <p>Sign in to Sumnews to unlock exclusive features like Push Notifications, Personalized News Feed and
                    more</p>
            </div>
        </div>
    </div>
