...
import { List, Sources, Genres, Filter } from '../../main.js'
...
async function filterHandler() {
    ...
    // if (query.sources != undefined || query.genres != undefined) {
    router.push({
        name: 'filter',
        query: query,
        force: true
    })
    // const storedSources = route.query.sources.split(',');
    // const storedGenres = route.query.sources.split(',');
...
<template>
    <div class="backdrop" @click="Filter.isVisible = false;">
