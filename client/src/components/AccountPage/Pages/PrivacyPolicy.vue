<template>
    <div>
        <!-- <p class="text-3xl"><span class="domain">Sumnews.net</span> Privacy Policy</p> -->
        <p>
        <h3>Effective date: 2024-01-03</h3>
        <p class="text-xl">1. Introduction</p>
        Welcome to sumnews.net.
        <br>
        sumnews.net (“us”, “we”, or “our”) operates sumnews.net (hereinafter referred to as “Service”).
        <br>
        Our Privacy Policy governs your visit to sumnews.net, and explains how we collect, safeguard and disclose
        information
        ...
        information in
        accordance with this policy. Unless otherwise defined in this Privacy Policy, the terms used in this Privacy Policy
        have
        ...
        <b>SERVICE</b> means the sumnews.net website operated by sumnews.net.

        <br>
        <b>PERSONAL DATA</b> means data about a living individual who can be identified from those data (or from those and
        other
        ...
        <br>
        <b>DATA PROCESSORS (OR SERVICE PROVIDERS)</b> means any natural or legal person who processes the data on behalf of
        the
        Data Controller. We may use the services of various Service Providers in order to process your data more
        effectively.
        ...
        <br>
        <b>THE USER</b> is the individual using our Service. The User corresponds to the Data Subject, who is the subject of
        Personal Data.
        ...
        <br>
        0.4. Advertising Cookies: Advertising Cookies are used to serve you with advertisements that may be relevant to you
        and
        your interests.
        <br>
        <br>
        ...
        <br>
        <br>
        <p class="text-xl">5. Use of Data</p>
        sumnews.net uses the collected data for various purposes:
        <br>
        ...
        <br>
        0.11. to provide you with news, special offers and general information about other goods, services and events which
        we
        ...
        period, except when this data is used to strengthen the security or to improve the functionality of our Service, or
        ...
        your
        state, province, country or other governmental jurisdiction where the data protection laws may differ from those of
        your
        jurisdiction.
        <br>
        If you are located outside USA and choose to provide information to us, please note that we transfer the data,
        including
        Personal Data, to USA and process it there.
        <br>
        Your consent to this Privacy Policy followed by your submission of such information represents your agreement to
        that
        transfer.
        <br>
        sumnews.net will take all the steps reasonably necessary to ensure that your data is treated securely and in
        accordance
        ...
        <br>
        <br>
        <p class="text-xl">8. Disclosure of Data</p>
        ...
        <br>
        <br>
        <p class="text-xl">9. Security of Data</p>
        ...
        <br>
        <br>
        <p class="text-xl">10. Your Data Protection Rights Under General Data Protection Regulation (GDPR)</p>
        ...
        please email us at support@sumnews.net.
        <br>
        ...
        <br>
        0.6. the right to withdraw consent. You also have the right to withdraw your consent at any time where we rely on
        your
        ...
        <br>
        <br>
        <p class="text-xl">11. Your Data Protection Rights under the California Privacy Protection Act (CalOPPA)</p>
        ...
        <br>
        0.4. users are able to change their personal information by emailing us at support@sumnews.net.
        <br>
        ...
        <br>
        <br>
        <p class="text-xl">12. Your Data Protection Rights under the California Consumer Privacy Act (CCPA)</p>

        If you are a California resident, you are entitled to learn what data we collect about you, ask to delete your data
        and
        ...
        <br>
        0.0.6. A list of categories of personal information that we have sold, along with the category of any other company
        we
        ...
        cases, deletion may be accomplished through de-identification of the information. If you choose to delete your
        personal
        information, you may not be able to use certain functions that require your personal information to operate.
        <br>
        0.3. To stop selling your personal information. We don’t sell or rent your personal information to any third parties
        for
        any purpose. We do not sell your personal information for monetary consideration. However, under some circumstances,
        a
        transfer of personal information to a third party, or within our family of companies, without monetary consideration
        may
        be considered a “sale” under California law. You are the only owner of your Personal Data and can request disclosure
        or
        ...
        not
        be able to participate in certain programs or membership services which require the usage of your personal
        information
        ...
        <p class="text-xl">13. Service Providers</p>
        ...
        <p class="text-xl">14. Analytics</p>

        We may use third-party Service Providers to monitor and analyze the use of our Service.
        <br>
        <br>
        <p class="text-xl">15. CI/CD tools</p>

        We may use third-party Service Providers to automate the development process of our Service.
        <br>
        <br>
        <p class="text-xl">16. Advertising</p>

        We may use third-party Service Providers to show advertisements to you to help support and maintain our Service.
        <br>
        <br>
        <p class="text-xl">17. Behavioral Remarketing</p>

        We may use remarketing services to advertise on third party websites to you after you visited our Service. We and
        our
        third-party vendors use cookies to inform, optimise and serve ads based on your past visits to our Service.
        <br>
        <br>
        <p class="text-xl">18. Payments</p>
        ...
        payment
        processors whose use of your personal information is governed by their Privacy Policy. These payment processors
        adhere
        to the standards set by PCI-DSS as managed by the PCI Security Standards Council, which is a joint effort of brands
        like
        ...
        <p class="text-xl">19. Links to Other Sites</p>
        ...
        For example, the outlined privacy policy has been made using PolicyMaker.io, a free tool that helps create
        high-quality
        legal documents. PolicyMaker’s privacy policy generator is an easy-to-use tool for creating a privacy policy for
        blog,
        website, e-commerce store or mobile app.
        <br>
        <br>
        <p class="text-xl">20. Children’s Privacy</p>
        ...
        If you have any questions about this Privacy Policy, please contact us by email: support@sumnews.net.
        <br>
        <br>
        <p class="text-xs">This Privacy Policy was created for sumnews.net by PolicyMaker.io on 2024-01-03.</p>
    </div>
</template>
