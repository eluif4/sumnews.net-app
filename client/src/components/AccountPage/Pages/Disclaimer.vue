<template>
    <div>
        ...
        The information provided by sumnews.net (“Company”, “we”, “our”, “us”) on sumnews.net (the “Site”) is for general
        ...
        <p class="text-xl">EXTERNAL LINKS DISCLAIMER</p>
        ...
        <br>
        <br>
        For example, the outlined Disclaimer has been created using PolicyMaker.io, a free web application for generating
        high-quality legal documents. PolicyMaker’s disclaimer generator is an easy-to-use tool for creating an excellent
        sample
        Disclaimer template for a website, blog, eCommerce store or app.
        <br>
        <br>
        ...
        <br>
        <br>
        <p class="text-xl">ERRORS AND OMISSIONS DISCLAIMER</p>

        While we have made every attempt to ensure that the information contained in this site has been obtained from
        reliable
        sources, sumnews.net is not responsible for any errors or omissions or for the results obtained from the use of this
        information. All information in this site is provided “as is”, with no guarantee of completeness, accuracy,
        timeliness
        ...
        In no event will sumnews.net, its related partnerships or corporations, or the partners, agents or employees thereof
        be
        ...
        <p class="text-xl">LOGOS AND TRADEMARKS DISCLAIMER</p>

        All logos and trademarks of third parties referenced on sumnews.net are the trademarks and logos of their respective
        owners. Any inclusion of such trademarks or logos does not imply or constitute any approval, endorsement or
        sponsorship
        of sumnews.net by such owners.
        <br>
        <br>
