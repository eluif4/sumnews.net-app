<template>
    <div>
        ...
        <br>
        These Terms of Service (“Terms”, “Terms of Service”) govern your use of our website located at sumnews.net (together
        or
        individually “Service”) operated by sumnews.net.
        <br>
        ...
        know by
        emailing at support@sumnews.net so we can try to find a solution. These Terms apply to all visitors, users and
        others
        who wish to access or use Service.
        <br>
        <br>
        <p class="text-xl">2. Communications</p>
        ...
        unsubscribe link or by emailing at support@sumnews.net.
        <br>
        <br>
        <p class="text-xl">3. Contests, Sweepstakes and Promotions</p>
        ...
        <br>
        <br>
        <p class="text-xl">4. Content</p>

        Content found on or through this Service are the property of sumnews.net or used with permission. You may not
        ...
        <br>
        <br>
        <p class="text-xl">5. Prohibited Uses</p>
        ...
        <br>
        <br>
        <p class="text-xl">6. Analytics</p>

        We may use third-party Service Providers to monitor and analyze the use of our Service.
        <br>
        <br>
        <p class="text-xl">7. No Use By Minors</p>
        ...
        <br>
        <br>
        <p class="text-xl">8. Accounts</p>

        When you create an account with us, you guarantee that you are above the age of 18, and that the information you
        provide
        us is accurate, complete, and current at all times. Inaccurate, incomplete, or obsolete information may result in
        the
        ...
        or
        actions that occur under your account and/or password, whether your password is with our Service or a third-party
        service. You must notify us immediately upon becoming aware of any breach of security or unauthorized use of your
        account.
        <br>
        ...
        copied
        in a way that constitutes copyright infringement, please submit your claim via email to support@sumnews.net, with
        the
        subject line: “Copyright Infringement” and include in your claim a detailed description of the alleged Infringement
        as
        ...
        <br>
        <br>
        <p class="text-xl">11. DMCA Notice and Procedure for Copyright Infringement Claims</p>
        ...
        <br>
        You can contact our Copyright Agent via email at support@sumnews.net.
        <br>
        <br>
        <p class="text-xl">12. Error Reporting and Feedback</p>

        You may provide us either directly at support@sumnews.net or via third party sites and tools with information and
        ...
        third party; and (iv) Company is not under any obligation of confidentiality with respect to the Feedback. In the
        event
        the transfer of the ownership to the Feedback is not possible due to applicable mandatory laws, you grant Company
        and
        its affiliates an exclusive, transferable, irrevocable, free-of-charge, sub-licensable, unlimited and perpetual
        right to
        use (including copy, modify, create derivative works, publish, distribute and commercialize) Feedback in any manner
        and
        for any purpose.
        <br>
        <br>

        <p class="text-xl">13. Links To Other Web Sites</p>

        Our Service may contain links to third party web sites or services that are not owned or controlled by sumnews.net.
        <br>
        sumnews.net has no control over, and assumes no responsibility for the content, privacy policies, or practices of
        any
        ...
        high-quality legal documents. PolicyMaker’s Terms and Conditions generator is an easy-to-use free tool for creating
        an
        ...
        <br>
        <br>
        <p class="text-xl">14. Disclaimer Of Warranty</p>
        ...
        SERVICES OR ITEMS OBTAINED THROUGH THE SERVICES WILL BE ACCURATE, RELIABLE, ERROR-FREE, OR UNINTERRUPTED, THAT
        DEFECTS
        ...
        <br>
        <br>
        <p class="text-xl">15. Limitation Of Liability</p>
        ...
        ALL
        RELATED COSTS AND EXPENSES OF LITIGATION AND ARBITRATION, OR AT TRIAL OR ON APPEAL, IF ANY, WHETHER OR NOT
        LITIGATION OR
        ARBITRATION IS INSTITUTED), WHETHER IN AN ACTION OF CONTRACT, NEGLIGENCE, OR OTHER TORTIOUS ACTION, OR ARISING OUT
        OF OR
        ...
        <br>
        <br>
        <p class="text-xl">16. Termination</p>

        We may terminate or suspend your account and bar access to Service immediately, without prior notice or liability,
        under
        our sole discretion, for any reason whatsoever and without limitation, including but not limited to a breach of
        Terms.
        <br>
        ...
        <p class="text-xl">17. Governing Law</p>

        These Terms shall be governed and construed in accordance with the laws of USA, which governing law applies to
        agreement
        ...
        <p class="text-xl">18. Changes To Service</p>
        ...
        time
        or for any period. From time to time, we may restrict access to some parts of Service, or the entire Service, to
        users,
        including registered users.
        <br>
        <br>
        <p class="text-xl">19. Amendments To Terms</p>
        ...
        <p class="text-xl">20. Waiver And Severability</p>

        No waiver by Company of any term or condition set forth in Terms shall be deemed a further or continuing waiver of
        such
        term or condition or a waiver of any other term or condition, and any failure of Company to assert a right or
        provision
        ...
        <p class="text-xl">21. Acknowledgement</p>
        ...
        <br>
        <br>
        <p class="text-xl">22. Contact Us</p>

        Please send your feedback, comments, requests for technical support by email: support@sumnews.net.
        <br>
        <br>
