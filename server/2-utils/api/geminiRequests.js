...
const summarizeTask = `TASK: Summarize the following article in 100 words or less, highlighting key points and emphasizing the most important information. FOLLOW AND IMPLEMENT ALL OF THE REQUIREMENTS BELOW!
REQUIREMENTS: 
1. SUMMARIZING: Omit redundancy and irrelevant details, ensuring the summary is precise, relevant, and informative based solely on the article's content. 
2. FORMATTING FOUNDATIONS: The list below outlines how to format your response, from most to least important. Nest format options, such as quoting a sentence while using vocabulary tags around a word in that quote. Examples:
...
FALLBACK: If you don't have enough information about the article or aren't able to make a reasonable summary return the single word "Error".`
